...
const platforms = [
  {
    ...
    format: "EXE, MSI, ZIP",
    icon: "/win-svg.svg",
    downloadUrl: `${RELEASE_BASE_URL}/devicehub-${RELEASE_VERSION}-windows-x64-setup.exe`,
  },
  {
    name: "macOS",
    format: "DMG",
    icon: "/apple-svg.svg",
    downloadUrl: `${RELEASE_BASE_URL}/devicehub-${RELEASE_VERSION}-macos-arm64.dmg`,
  },
  {
    name: "Linux",
    format: "DEB, AppImage",
    icon: "/linux-svg.svg",
    downloadUrl: `${RELEASE_BASE_URL}/devicehub-${RELEASE_VERSION}-linux-x64.AppImage`,
  },
];
      ...
      <Container className="text-center">
        ...
        <div className="mx-auto mt-12 flex max-w-2xl flex-col items-center gap-4 sm:flex-row sm:justify-center">
          {platforms.map((platform, i) => (
            ...
            >
              <img src={platform.icon} alt={platform.name} className="h-8 w-8 dark:[filter:brightness(0)_invert(1)]" />
              <div>
